...
def create_tts_fn(model, hps, speaker_ids):
    def tts_fn(text, speaker, language, speed, noise_scale=.667, noise_scale_w=0.8):
        ...
        with gr.Tab("Text-to-Speech"):
            with gr.Row():
                with gr.Column():
                    ...
                    noise_scale = gr.Slider(minimum=0.001, maximum=1, value=0.667, step=0.001,
                                                label='noise_scale')
                    noise_scale_w = gr.Slider(minimum=0.001, maximum=1, value=0.8, step=0.001,
                                                label='noise_scale_w')
                with gr.Column():
                    ...
                    btn.click(tts_fn,
                              inputs=[textbox, char_dropdown, language_dropdown, duration_slider,noise_scale, noise_scale_w,],
